...
class Game extends React.Component {
  ...
  handleChange = (event) => {
    this.setState({
      lyricText: songs[event.target.value - 1].lyrics,
      ...
      <Box display="flex" alignItems="center">
        <Box width="100%" mr={1}>
          <LinearProgress
            ...
            variant="determinate"
            {...props}
            style={{ height: "10px", borderRadius: "15px", width: "100%" }}
          />
        </Box>
        <Box minWidth={35}>
  ...
  render() {
    return (
      ...
      >
        ...
        <LyricWindow
          lyrics={songs[1].lyrics}
          wpm={this.getWpm}
          startTimer={this.state.startTimer}
          gameTimer={this.state.gameTimer}
          progress={this.setCompleted}
        />
        <p
          style={{
            textAlign: "left",
        ...
        <p style={{ textAlign: "left", marginLeft: "20px", fontSize: "18px" }}>
          beware of cap lock
        </p>
        <p style={{ textAlign: "left", marginLeft: "20px", fontSize: "18px" }}>
          have fun!!
        ...
        <div style={{ position: "absolute", right: "20px", top: "80px" }}>
          <p style={{ padding: "0", margin: "0", fontSize: "18px" }}>
            words per minute
          </p>
          {this.state.wpm}
        </div>
        <Tooltip
          title="credits: abdi, leo, mike"
